...
const dailyConnectionChallenges: DailyBonusChallenge[] = [
  ...
  { title: 'Ocean group', kind: 'Connections', prompt: 'What connects Pacific, Atlantic, and Indian?', options: ['Mountain ranges', 'World oceans', 'Deserts'], correctOption: 1, explanation: 'The Pacific, Atlantic, and Indian are three of Earth’s five oceans.', difficulty: 'easy' },
  { title: 'Musical family', kind: 'Connections', prompt: 'What connects violin, viola, and cello?', options: ['String instruments', 'Woodwind instruments', 'Percussion instruments'], correctOption: 0, explanation: 'All three belong to the bowed string family.', difficulty: 'easy' },
  { title: 'Primary palette', kind: 'Connections', prompt: 'What connects red, yellow, and blue in traditional painting?', options: ['Primary colours', 'Cool colours', 'Metallic colours'], correctOption: 0, explanation: 'They are the traditional primary colours used to mix many other colours.', difficulty: 'easy' },
  { title: 'Capital trio', kind: 'Connections', prompt: 'What connects Paris, Rome, and Madrid?', options: ['European capital cities', 'Major rivers', 'Greek islands'], correctOption: 0, explanation: 'Each is the capital city of a European country.', difficulty: 'easy' },
  { title: 'Pollinator link', kind: 'Connections', prompt: 'What connects bees, butterflies, and hummingbirds?', options: ['They are nocturnal', 'They pollinate flowers', 'They live underwater'], correctOption: 1, explanation: 'All three can carry pollen between flowers and help plants reproduce.', difficulty: 'easy' },
  { title: 'Board pieces', kind: 'Connections', prompt: 'What connects king, queen, and bishop?', options: ['Chess pieces', 'Playing-card suits', 'Roman gods'], correctOption: 0, explanation: 'The king, queen, and bishop are all pieces used in chess.', difficulty: 'easy' },
  { title: 'Frozen forms', kind: 'Connections', prompt: 'What connects snow, hail, and frost?', options: ['Forms of frozen water', 'Types of cloud', 'Ocean currents'], correctOption: 0, explanation: 'Each is water in a frozen form produced by cold weather conditions.', difficulty: 'easy' },
  { title: 'Triangle family', kind: 'Connections', prompt: 'What connects equilateral, isosceles, and scalene?', options: ['Types of triangle', 'Types of angle', 'Types of polygon with five sides'], correctOption: 0, explanation: 'They classify triangles by the lengths of their sides.', difficulty: 'easy' },
  { title: 'Story genres', kind: 'Connections', prompt: 'What connects mystery, fantasy, and biography?', options: ['Literary genres', 'Newspaper sections', 'Poetic metres'], correctOption: 0, explanation: 'Each describes a genre or category of book.', difficulty: 'easy' },
  ...
  { title: 'Nobel scientists', kind: 'Connections', prompt: 'What connects Marie Curie, Albert Einstein, and Niels Bohr?', options: ['They won Nobel Prizes in Physics', 'They discovered planets', 'They were British prime ministers'], correctOption: 0, explanation: 'All three received the Nobel Prize in Physics for major scientific work.', difficulty: 'medium' },
  { title: 'Strait cities', kind: 'Connections', prompt: 'What connects Istanbul, Singapore, and Copenhagen?', options: ['They sit beside important straits', 'They are landlocked capitals', 'They lie on the Equator'], correctOption: 0, explanation: 'Each city lies beside a strategically important strait or narrow sea passage.', difficulty: 'medium' },
  { title: 'Element endings', kind: 'Connections', prompt: 'What connects helium, lithium, and sodium?', options: ['Chemical elements ending in “ium”', 'Noble gases only', 'Synthetic plastics'], correctOption: 0, explanation: 'All three are chemical elements whose English names end in “ium”.', difficulty: 'medium' },
  { title: 'Art movements', kind: 'Connections', prompt: 'What connects Monet, Renoir, and Degas?', options: ['Impressionist artists', 'Renaissance sculptors', 'Modern architects'], correctOption: 0, explanation: 'All three are closely associated with French Impressionism.', difficulty: 'medium' },
  { title: 'Mythical homes', kind: 'Connections', prompt: 'What connects Olympus, Asgard, and Valhalla?', options: ['Places from mythology', 'Volcanoes in Italy', 'Ancient trade routes'], correctOption: 0, explanation: 'They are important places in Greek or Norse mythology.', difficulty: 'medium' },
  { title: 'Revolutionary documents', kind: 'Connections', prompt: 'What connects Magna Carta, the US Constitution, and the Universal Declaration of Human Rights?', options: ['Influential rights documents', 'Medieval poems', 'Military treaties only'], correctOption: 0, explanation: 'Each is an influential document concerned with law, government, or individual rights.', difficulty: 'medium' },
  { title: 'Island nations', kind: 'Connections', prompt: 'What connects Iceland, Madagascar, and Japan?', options: ['Island nations', 'Countries in South America', 'Members of the same archipelago'], correctOption: 0, explanation: 'Each is a sovereign country located wholly on one or more islands.', difficulty: 'medium' },
  { title: 'Scale pattern', kind: 'Connections', prompt: 'What connects Richter, Mohs, and Beaufort?', options: ['Named measurement scales', 'European mountain ranges', 'Units of currency'], correctOption: 0, explanation: 'They are named scales for earthquake magnitude, mineral hardness, and wind force.', difficulty: 'medium' },
  { title: 'Space pioneers', kind: 'Connections', prompt: 'What connects Yuri Gagarin, Valentina Tereshkova, and Neil Armstrong?', options: ['Spaceflight pioneers', 'Polar explorers', 'Nobel-winning chemists'], correctOption: 0, explanation: 'Each achieved a landmark first in human spaceflight.', difficulty: 'medium' },
  ...
  { title: 'Peace names', kind: 'Connections', prompt: 'What connects Westphalia, Versailles, and Utrecht?', options: ['Major peace settlements', 'Schools of painting', 'Pacific islands'], correctOption: 0, explanation: 'Each name is associated with a major European peace treaty or settlement.', difficulty: 'hard' },
  { title: 'Scientific constants', kind: 'Connections', prompt: 'What connects Planck, Boltzmann, and Avogadro?', options: ['They give names to scientific constants', 'They are lunar craters only', 'They invented vaccines'], correctOption: 0, explanation: 'Each scientist’s name is attached to a fundamental constant used in physics or chemistry.', difficulty: 'hard' },
  { title: 'Novel openings', kind: 'Connections', prompt: 'What connects Ishmael, Ahab, and the Pequod?', options: ['Moby-Dick', 'Treasure Island', 'The Odyssey'], correctOption: 0, explanation: 'All three are central to Herman Melville’s novel Moby-Dick.', difficulty: 'hard' },
  { title: 'Logical forms', kind: 'Connections', prompt: 'What connects modus ponens, modus tollens, and syllogism?', options: ['Forms of logical reasoning', 'Musical tempos', 'Roman building styles'], correctOption: 0, explanation: 'They are structures or methods used to draw conclusions in logic.', difficulty: 'hard' },
  { title: 'Boundary rivers', kind: 'Connections', prompt: 'What connects the Rio Grande, Oder, and Mekong?', options: ['They form parts of international borders', 'They all flow into the Arctic Ocean', 'They are entirely underground'], correctOption: 0, explanation: 'Each river forms part of a boundary between countries along some of its course.', difficulty: 'hard' },
  { title: 'Ancient libraries', kind: 'Connections', prompt: 'What connects Alexandria, Pergamum, and Nineveh?', options: ['Sites of major ancient libraries', 'Birthplaces of Roman emperors', 'Medieval universities in Britain'], correctOption: 0, explanation: 'Each ancient city was known for an important library or collection of texts.', difficulty: 'hard' },
  { title: 'Economic thinkers', kind: 'Connections', prompt: 'What connects Adam Smith, John Maynard Keynes, and Milton Friedman?', options: ['Influential economists', 'Abstract painters', 'Classical composers'], correctOption: 0, explanation: 'All three profoundly influenced economic theory and policy.', difficulty: 'hard' },
  { title: 'Medical names', kind: 'Connections', prompt: 'What connects Parkinson, Alzheimer, and Hodgkin?', options: ['Surnames used in disease names', 'Inventors of surgical tools', 'Types of blood cell'], correctOption: 0, explanation: 'Each is a surname used in the established name of a medical condition.', difficulty: 'hard' },
  { title: 'Language families', kind: 'Connections', prompt: 'What connects Hindi, Persian, and English?', options: ['Indo-European languages', 'Semitic languages', 'Writing systems rather than languages'], correctOption: 0, explanation: 'All three belong to branches of the Indo-European language family.', difficulty: 'hard' },
];
...
function getDailyConnections(dateKey: string) {
  ...
  return (['easy', 'medium', 'hard'] as const).map((difficulty) => {
    ...
    const cycle = Math.floor(challengeNumber / candidates.length);
    const cycleOrder = seededShuffle(candidates, createSeededRandom(getDailySeed(`quizo-connections-${difficulty}-cycle-${cycle}`)));
    return cycleOrder[challengeNumber % candidates.length];
  });
}
...
function DashboardLaunchGrid({
  ...
  return (
    <div className="dashboard-today">
      ...
      <section className="dashboard-today-plan"><div className="dashboard-plan-intro"><div><p className="eyebrow">Today on Quizo</p><h2>Your {todayMinutes}-minute session</h2><p>Built around {focusLabel}. Change the time and Quizo will reshape the session.</p></div><div className="dashboard-time-picker" aria-label="Choose session duration">{([5, 10, 15, 30] as const).map((minutes) => <button className={todayMinutes === minutes ? 'active' : ''} key={minutes} onClick={() => chooseTodayMinutes(minutes)} type="button">{minutes}<small>min</small></button>)}</div></div><div className="dashboard-plan-body"><div className="dashboard-plan-list">{todayPlan.map((item, index) => <article className={item.tone} key={item.id}><span>{item.icon}</span><div><small>{index === 0 ? 'Start here' : `Then · about ${item.minutes} min`}</small><strong>{item.title}</strong><p>{item.detail}</p></div><b>{item.minutes} min</b></article>)}</div><aside><span><Target size={22} /></span><small>Your session</small><strong>{todayPlan.length} activit{todayPlan.length === 1 ? 'y' : 'ies'} · about {plannedMinutes} min</strong><p>{todayAttempt ? 'Today’s challenge is already complete, so your plan has moved on.' : todayMinutes < 10 ? 'A focused quick win for the time you have.' : 'Complete each activity, then return here for the next one.'}</p><button className="primary-button" onClick={nextTodayItem.action} type="button"><Play size={17} /> Start my session</button></aside></div></section>
