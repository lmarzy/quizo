alter table public.games
  alter column max_consecutive_questions set default 2;

alter table public.games
  add column if not exists current_turn_attempt integer not null default 1 check (current_turn_attempt between 1 and 20);

update public.games
set max_consecutive_questions = 2
where max_consecutive_questions = 3
